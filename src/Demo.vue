  ...
  <div class="demo">
    <v-sidebar dark>
      <v-sidebar-items title="Testing" hoverEffect>
        ...
        <v-sidebar-item>Test 3</v-sidebar-item>
        <v-sidebar-item>Test 4</v-sidebar-item>
        <v-sidebar-item>Test 5</v-sidebar-item>
        <v-sidebar-item>
      ...
      <v-sidebar-content>
        <v-row center>
          <v-col c6>
            ...
            <v-date-picker dark></v-date-picker>
    ...
    import asdfmovie
            ...
            <v-search-bar dark placeholder="Suchen ...">test</v-search-bar>
